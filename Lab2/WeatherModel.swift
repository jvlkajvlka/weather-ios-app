...
struct WeatherModel {
    ...
    var descriptions2: [String] = ["Snow", "Sleet", "Hail", "Thunderstorm", "Heavy Rain", "Light Rain", "Showers", "Heavy Cloud", "Light Cloud", "Clear"]
    ...
    mutating func refresh(record: WeatherRecord){
        ...
        records[index!].temperature = round(temperature*100) / 100
    ...
    mutating func refreshState(record: WeatherRecord, counter: Int){
        ...
        records[index!].recordState = states[counter]
    }
}
